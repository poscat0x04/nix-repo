{ buildFirefoxXpiAddon, fetchurl, lib, stdenv }:
  {
    ...
    "bypass-paywalls-clean" = buildFirefoxXpiAddon {
      ...
      url = "https://addons.mozilla.org/firefox/downloads/file/3867881/bypass_paywalls_clean-2.4.4.0-an+fx.xpi";
      sha256 = "904d043000ab4be4408a2e7173280050cae562d829736b52ced151dfa0dd8ebd";
      meta = with lib;
      {
    ...
    "grammarly" = buildFirefoxXpiAddon {
      ...
      url = "https://addons.mozilla.org/firefox/downloads/file/3866318/grammarly_for_firefox-8.889.0-an+fx.xpi";
      sha256 = "cd0d4bb1d19d6eb53c68021413d5ff4e761abd627c4d872eebe1e7fa55fe000b";
      meta = with lib;
      {
    ...
    "sponsorblock" = buildFirefoxXpiAddon {
      ...
      url = "https://addons.mozilla.org/firefox/downloads/file/3866051/sponsorblock_skip_sponsorships_on_youtube-3.6.1-an+fx.xpi";
      sha256 = "d426be3a22e93fd55156fadcc7a6fac83237d74f103abb32b7111984d7db0f40";
      meta = with lib;
      {
