{ buildFirefoxXpiAddon, fetchurl, lib, stdenv }:
  {
    ...
    "bypass-paywalls-clean" = buildFirefoxXpiAddon {
      ...
      url = "https://addons.mozilla.org/firefox/downloads/file/3861105/bypass_paywalls_clean-2.4.2.0-an+fx.xpi";
      sha256 = "29fe02d3a5581ec3f0ffd727dbbdde517dc2554037dd3939ea90769c39d07db5";
      meta = with lib;
      {
    ...
    "sponsorblock" = buildFirefoxXpiAddon {
      ...
      url = "https://addons.mozilla.org/firefox/downloads/file/3861785/sponsorblock_skip_sponsorships_on_youtube-3.5.2-an+fx.xpi";
      sha256 = "3097b77bc1976ec1ce589af09cb832cf271db54ee4309c1c14e297f435ae819e";
      meta = with lib;
      {
