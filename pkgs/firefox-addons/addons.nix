{ buildFirefoxXpiAddon, fetchurl, lib, stdenv }:
  {
    ...
    "bypass-paywalls-clean" = buildFirefoxXpiAddon {
      ...
      url = "https://addons.mozilla.org/firefox/downloads/file/3891233/bypass_paywalls_clean-2.5.1.0-an+fx.xpi";
      sha256 = "9e6d133b6f96beaffea02c241b12882aaa723cfe4e952f2bbc36d287b5473838";
      meta = with lib;
      {
    ...
    "sponsorblock" = buildFirefoxXpiAddon {
      ...
      url = "https://addons.mozilla.org/firefox/downloads/file/3893908/sponsorblock_skip_sponsorships_on_youtube-4.0.1-an+fx.xpi";
      sha256 = "3e50614a10957946156a66046fa6dd21a86a3582e18b28016933fc1d330ee87e";
      meta = with lib;
      {
