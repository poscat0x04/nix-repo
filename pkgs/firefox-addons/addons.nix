{ buildFirefoxXpiAddon, fetchurl, lib, stdenv }:
  {
    ...
    "bypass-paywalls-clean" = buildFirefoxXpiAddon {
      ...
      url = "https://addons.mozilla.org/firefox/downloads/file/3934480/bypass_paywalls_clean-2.6.4.0-an+fx.xpi";
      sha256 = "c3921a396d8e537693cb8a26e756ac778db01584f784d991b0f4a8acd1f5b6d7";
      meta = with lib;
      {
    ...
    "floccus" = buildFirefoxXpiAddon {
      ...
      url = "https://addons.mozilla.org/firefox/downloads/file/3935943/floccus-4.13.0-fx.xpi";
      sha256 = "1ff85aa98280e2649edf3a7b62d9f87ad8950378589688284507d7dba7404f5b";
      meta = with lib;
      {
